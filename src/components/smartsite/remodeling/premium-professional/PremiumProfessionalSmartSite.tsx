...
// Composition root for Remodeling · Premium Professional. Deliberately NOT
// the same section lineup as HVAC/Plumbing/Painting Premium Professional:
// BeforeAfterGallery is promoted out of the Growth-tier gate and placed
// right after About — a renovation company's realized work is the
// argument for a high-ticket project, not a bonus feature buried near the
// bottom. HeroSplit + light SiteHeader/About keep the whole page free of
// dark sections, warm ivory/stone/taupe rather than the black/navy already
// used elsewhere.
export function PremiumProfessionalSmartSite({ business, tier, ownerPreview = false }: SmartSiteRenderProps) {
  ...
  return (
    <div className={`rmpp-smartsite ${displayFont.variable} ${bodyFont.variable} ${monoFont.variable}`}>
