...
import { buildBusinessDataFromWizard } from "@/lib/smartsite/electrical/build-business-data";

// Electrical's entry in the SmartSite registry — colocated with its
...
export const electricalRegistry: TradeRegistryEntry = {
  components: {
