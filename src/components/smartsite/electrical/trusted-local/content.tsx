// All copy, icon selection, and stat definitions for Electrical · Trusted
...
export const hero: HeroContent = {
  eyebrow: "Family-owned, serving the community since 2013",
  headlineLines: ["The name your", "neighbors already", "trust."],
  accentLineIndex: 2,
  subhead: (b) =>
    `${b.credentials.yearsInBusiness} years of keeping ${b.serviceArea.split(",")[0]} safe and powered — no call center, no big-city runaround, just the people down the street.`,
...
export const contact: ContactContent = {
  ...
  formLabels: {
    ...
    messagePlaceholder: "Our lights keep flickering in the kitchen…",
    submit: "Send It Over →",
  },
};
...
export const beforeAfter: BeforeAfterGalleryContent = {
  ...
  heading: "See what a proper upgrade actually does",
  items: [
    {
...
export const faq: FaqContent = {
  ...
  items: [
    { question: "Are you actually local, or a franchise?", answer: "Family-owned and locally based since 2013 — no call center, no franchise fees passed on to you." },
...
export const financing: FinancingContent = {
  ...
  body: "Stay safe now, pay over time — flexible plans available.",
