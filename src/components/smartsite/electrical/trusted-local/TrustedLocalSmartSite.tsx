...
// Composition root for Electrical · Trusted Local. Same shared sections and
// same tier ladder as Fast Response — only content.tsx, the token
// stylesheet, and fonts differ.
export function TrustedLocalSmartSite({ business, tier, ownerPreview = false }: SmartSiteRenderProps) {
  ...
  return (
    <div className={`etl-smartsite ${displayFont.variable} ${bodyFont.variable} ${monoFont.variable}`}>
