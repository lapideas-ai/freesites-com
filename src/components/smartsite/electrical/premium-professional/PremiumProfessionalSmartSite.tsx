...
// Composition root for Electrical · Premium Professional. Same shared
// sections and same tier ladder as the other two Electrical styles — only
// content.tsx, the token stylesheet, and fonts differ.
export function PremiumProfessionalSmartSite({ business, tier, ownerPreview = false }: SmartSiteRenderProps) {
  ...
  return (
    <div className={`epp-smartsite ${displayFont.variable} ${bodyFont.variable} ${monoFont.variable}`}>
