...
// Composition root for HVAC · Premium Professional. Same shared sections and
// same tier ladder as the other two HVAC styles — only content.tsx, the
// token stylesheet, and fonts differ.
export function PremiumProfessionalSmartSite({ business, tier, ownerPreview = false }: SmartSiteRenderProps) {
  ...
  return (
    <div className={`pp-smartsite ${displayFont.variable} ${bodyFont.variable} ${monoFont.variable}`}>
