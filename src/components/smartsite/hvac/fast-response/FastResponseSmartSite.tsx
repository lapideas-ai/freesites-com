...
// Composition root for HVAC · Fast Response. Every section here is a shared
// component — this file's only job is wiring business data + this style's
// content/tokens into them, and gating by product tier. Trusted Local and
// Premium Professional are siblings of this file, not copies of it.
//
