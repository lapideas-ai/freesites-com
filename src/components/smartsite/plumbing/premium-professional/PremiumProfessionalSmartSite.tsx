...
// Composition root for Plumbing · Premium Professional. Same shared sections
// and same tier ladder as the other two Plumbing styles — only content.tsx,
// the token stylesheet, and fonts differ.
export function PremiumProfessionalSmartSite({ business, tier, ownerPreview = false }: SmartSiteRenderProps) {
  ...
  return (
    <div className={`ppp-smartsite ${displayFont.variable} ${bodyFont.variable} ${monoFont.variable}`}>
