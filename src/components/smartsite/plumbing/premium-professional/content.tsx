// All copy, icon selection, and stat definitions for Plumbing · Premium
// Professional. Same shared components as the other two Plumbing styles —
...
export const hero: HeroContent = {
  eyebrow: "Precision plumbing engineering · Est. 2010",
  headlineLines: ["Exceptional plumbing,", "engineered with", "precision."],
  accentLineIndex: 2,
  subhead: () =>
    "Master-certified plumbers, premium fixtures, and a standard of care most plumbing companies don't offer. Your home, handled properly.",
...
export const services: ServicesContent = {
  eyebrow: "Our craft",
  heading: "Plumbing, engineered precisely",
  icons: plumbingServiceIcons,
};

export const about: AboutContent = {
  eyebrow: () => "The Bluewater difference",
  heading: () => "Precision in every detail.",
  highlights: [
    { icon: BadgeIcon, title: "Master Plumber Certified", subtitle: () => "Held to a higher technical standard." },
...
export const contact: ContactContent = {
  ...
  heading: "Let's discuss your plumbing",
  ...
  formLabels: {
    ...
    messagePlaceholder: "We're renovating and want to discuss a full repipe…",
...
export const trustBadges: TrustBadgesContent = {
  ...
  badges: [
    { icon: BadgeIcon, label: "Master Plumber Certified" },
...
export const faq: FaqContent = {
  ...
  items: [
    { question: "What makes this different from a standard plumbing company?", answer: "Master-certified plumbers, premium fixtures, and a white-glove service standard on every visit." },
...
export const financing: FinancingContent = {
  ...
  body: "Premium plumbing, structured to fit your plans.",
...
export const exploreMore: ExploreMoreContent = {
  ...
  items: [
    ...
    { icon: DocumentIcon, title: "From the Journal", description: "Notes on fixture design and water efficiency." },
  ],
};
