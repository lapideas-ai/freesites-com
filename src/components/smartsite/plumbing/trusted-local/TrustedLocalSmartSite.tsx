...
// Composition root for Plumbing · Trusted Local. Same shared sections and
...
export function TrustedLocalSmartSite({ business, tier, ownerPreview = false }: SmartSiteRenderProps) {
  ...
  return (
    <div className={`ptl-smartsite ${displayFont.variable} ${bodyFont.variable} ${monoFont.variable}`}>
