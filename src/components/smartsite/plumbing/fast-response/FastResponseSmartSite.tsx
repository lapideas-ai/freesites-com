...
// Composition root for Plumbing · Fast Response. Every section here is a
...
// it. Structurally identical to HVAC's Fast Response composition root by
// design — only the CSS import, root class name, and content module differ.
//
...
export function FastResponseSmartSite({ business, tier, ownerPreview = false }: SmartSiteRenderProps) {
  ...
  return (
    <div className={`pfr-smartsite ${displayFont.variable} ${bodyFont.variable} ${monoFont.variable}`}>
