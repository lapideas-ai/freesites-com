...
// built, not just filled out. Step 5 (Personalize) and Reveal already show
// the real SmartSite and don't need this.
export function WizardBuildingCue() {
  return (
    <div className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-orange-50 px-2.5 py-1 text-[11px] font-semibold text-[#ea6c0a]">
