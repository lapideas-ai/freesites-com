...
import { TrustedLocalSmartSite } from "@/components/smartsite/plumbing/trusted-local/TrustedLocalSmartSite";
    ...
    <div>
      <div className="sticky top-0 z-[100] flex flex-wrap items-center gap-4 border-b border-black/10 bg-white px-4 py-2.5">
        <span className="text-xs font-semibold uppercase tracking-wide text-black/40">
          Internal review — Plumbing · Trusted Local
        </span>
      ...
      <TrustedLocalSmartSite business={bluewaterSample} tier={tier} ownerPreview={ownerPreview} />
    </div>
  );
}
