...
import { PremiumProfessionalSmartSite } from "@/components/smartsite/plumbing/premium-professional/PremiumProfessionalSmartSite";
    ...
    <div>
      <div className="sticky top-0 z-[100] flex flex-wrap items-center gap-4 border-b border-black/10 bg-white px-4 py-2.5">
        <span className="text-xs font-semibold uppercase tracking-wide text-black/40">
          Internal review — Plumbing · Premium Professional
        </span>
      ...
      <PremiumProfessionalSmartSite business={bluewaterSample} tier={tier} ownerPreview={ownerPreview} />
    </div>
  );
}
