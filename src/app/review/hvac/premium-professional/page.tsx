...
export default function PremiumProfessionalReviewPage() {
  return (
    <OwnerReviewLayout
      title="HVAC · Premium Professional"
      ...
      previewPath="/preview/hvac/premium-professional"
      notes={[
        {
          title: "Restrained charcoal + muted brass, generous whitespace",
          rationale:
            "A homeowner paying a premium wants visual confirmation they're not just getting the same site with different words. Low-saturation brass instead of a bright accent, and more breathing room per section, reads as considered rather than urgent — deliberately the opposite instinct from Fast Response.",
        },
        {
        ...
        },
        {
          ...
          rationale:
            "\"NATE Master Certified\" and \"white-glove service standard\" replace the financing/overtime-rate claims used in the other two styles. A premium-position visitor is optimizing for quality assurance, not cost anxiety — leading with price reassurance here would work against the positioning.",
        },
        {
          title: "Contact copy asks to \"discuss your comfort,\" not \"tell us what's wrong\"",
          rationale:
        ...
        {
          title: "Light-weight Cormorant serif instead of a bold display face",
          rationale:
