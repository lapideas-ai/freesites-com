...
export default function PremiumProfessionalReviewPage() {
  return (
    <OwnerReviewLayout
      title="Plumbing · Premium Professional"
      ...
      previewPath="/preview/plumbing/premium-professional"
      notes={[
        {
          title: "Restrained navy + brushed nickel, generous whitespace",
          rationale:
            "A homeowner paying a premium wants visual confirmation they're not just getting the same site with different words. Low-saturation nickel instead of a bright accent, and more breathing room per section, reads as considered rather than urgent — deliberately the opposite instinct from Fast Response.",
        },
        {
        ...
        },
        {
          ...
          rationale:
            "\"Master Plumber Certified\" and \"white-glove service standard\" replace the financing/overtime-rate claims used in the other two styles. A premium-position visitor is optimizing for quality assurance, not cost anxiety — leading with price reassurance here would work against the positioning.",
        },
        {
          title: "Contact copy asks to \"discuss your plumbing,\" not \"tell us what's wrong\"",
          rationale:
        ...
        {
          title: "Light-weight Playfair Display serif instead of a bold display face",
          rationale:
