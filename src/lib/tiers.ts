...
export const tiers: Record<TierId, Tier> = {
  ...
  growth: {
    ...
    pitchHeadline: "Ready for a Complete Custom SmartSite?",
    pitchBody: "Everything in Pro, plus a more extensive custom SmartSite and FreeSites-managed implementation.",
